...
const Profile = (props) => {
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center px-5 pt-5 background-dashboard" style={{ marginBottom: '45px' }} >
      ...
      <div className='userInfo'>
        <div style={{ fontFamily: 'Arial, sans-serif', border: '1px solid #ccc', padding: '40px', borderRadius: '12px', maxWidth: '600px', margin: '15em auto 0', position: 'relative', top: '50%', transform: 'translateY(-50%)' }}>
          <h2 style={{ textAlign: 'center', fontSize: '24px', marginBottom: '40px' }}>User Information</h2>
          ...
          <div style={{ marginBottom: '30px' }}>
            <ul style={{ listStyle: 'none', padding: '0' }}>
              <li style={{ marginBottom: '12px', fontSize: '16px', wordWrap: 'break-word' }}>
